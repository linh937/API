...
<main>
      <div className="container_banner">
        <form className="form_container" action="/account/login" method="post">
          <div className="logo_container"></div>
          <div className="title_container">
            <p className="title">Đăng Nhập</p>
            <span className="subtitle">
              Bắt đầu với ứng dụng của chúng tôi, chỉ cần tạo một tài khoản và tận hưởng trải nghiệm mua sắm.
            </span>
          </div>
          <br />
          <div className="input_container">
            ...
            <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className="icon">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" stroke="#141B34" d="M7 8.5L9.94202 10.2394C11.6572 11.2535 12.3428 11.2535 14.058 10.2394L17 8.5"></path>
            ...
            <input placeholder="name@mail.com" name="username" type="text" className="input_field" id="email_field" />
          </div>
          <div className="input_container">
            ...
            <input placeholder="Password" name="password" className="input_field" id="password_field" />
          </div>
          <div className="showpassw">
            <input type="checkbox" /> Show Password
          </div>
          <div className="input_container form-check">
            <input type="checkbox" className="form-check-input" id="exampleCheck1" name="remember" value="true" />
            <label className="form-check-label" htmlFor="exampleCheck1">Ghi nhớ tài khoản?</label>
          </div>
          <button type="submit" >
            <span>Đăng Nhập</span>
          </button>
          ...
          <a title="Sign In" className="sign-in_ggl">
            ...
            <span>
              <img src="https://img.icons8.com/fluency/48/null/google-logo.png" style={{ width: '28px' }} alt="Google Logo" /> Đăng nhập với Google
            </span>
          </a>
          <p className="note">
            Bạn mới sử dụng? <a href="/register" style={{ color: 'red', textDecoration: 'none' }}>Đăng Ký</a>
          </p>
          <a href="/account/forget" style={{ color: 'red', textDecoration: 'none' }}>Quên mật khẩu?</a>
        </form>
      </div>
    </main>
    )
